...
export function Navigation() {
  return (
    <nav className="w-full">
      <div className="hidden xs:flex items-center w-full ">
        ...
        <Input
          ...
          className="bg-white max-w-[450px] hidden sm:block"
        />
      ...
      <div className="xs:hidden text-xl text-primary p-2">
        <RxHamburgerMenu className="cursor-pointer hover:text-primary/75 transition-colors" />
      </div>
    </nav>
  );
}
